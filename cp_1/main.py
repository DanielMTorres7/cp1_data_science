...
games_df = pd.read_csv('cp_1/data/games_mental_health.csv').drop(columns=['ID'])
print(games_df)
...
plt.savefig('cp_1/graphs/histograma_horas_jogando.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('cp_1/graphs/boxplot_estresse_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend()
plt.savefig('cp_1/graphs/scatter_plot_estresse.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('cp_1/graphs/heatmap_nivel_estresse_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('cp_1/graphs/heatmap_idade_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('cp_1/graphs/barplot_horas_idade_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('Gênero', fontsize=12)
plt.ylabel('Faixa de Idade', fontsize=12)
plt.savefig('cp_1/graphs/heatmap_horas_idade_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('Gênero', fontsize=12)
plt.ylabel('Nível de Estresse', fontsize=12)
plt.savefig('cp_1/graphs/barplot_estresse_genero.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('cp_1/graphs/lineplot_estresse_horas.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('Gênero', fontsize=12)
plt.savefig('cp_1/graphs/heatmap_estresse_genero_horas.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('Gênero', fontsize=12)
plt.savefig('cp_1/graphs/heatmap_estresse_genero_idade.png', dpi=300, bbox_inches='tight')
plt.show()
...
def plot_heatmap(data, title, cmap='YlOrRd'):
    ...
    plt.xlabel('Horas Jogadas por Semana', fontsize=12)
    plt.ylabel('Faixa de Idade', fontsize=12)
    plt.savefig(f'cp_1/graphs/heatmap_{title}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
for genero in generos:
    ...
    plt.xlabel('Horas Jogadas por Semana', fontsize=12)
    plt.ylabel('Frequência', fontsize=12)
    plt.savefig(f'cp_1/graphs/histograma_horas_jogando_{genero}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
for genero in generos:
    ...
    plt.xlabel('Horas Jogadas por Semana', fontsize=12)
    plt.ylabel('Nível de Estresse', fontsize=12)
    plt.savefig(f'cp_1/graphs/boxplot_estresse_horas_{genero}.png', dpi=300, bbox_inches='tight')
    plt.show()
...
for genero in generos:
    ...
    plt.legend()
    plt.savefig(f'cp_1/graphs/scatter_plot_estresse_horas_{genero}.png', dpi=300, bbox_inches='tight')
    plt.show()